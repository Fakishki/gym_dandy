...
with app.app_context():
    ...
    w01.created_at = datetime.strptime("2023-05-11 00:09:16", "%Y-%m-%d %H:%M:%S")
    w02.created_at = datetime.strptime("2023-05-12 00:09:16", "%Y-%m-%d %H:%M:%S")
    w03.created_at = datetime.strptime("2023-05-13 00:09:16", "%Y-%m-%d %H:%M:%S")
    w04.created_at = datetime.strptime("2023-05-14 00:09:16", "%Y-%m-%d %H:%M:%S")
    w05.created_at = datetime.strptime("2023-05-15 00:09:16", "%Y-%m-%d %H:%M:%S")
    w06.created_at = datetime.strptime("2023-05-16 00:09:16", "%Y-%m-%d %H:%M:%S")
    w07.created_at = datetime.strptime("2023-05-17 00:09:16", "%Y-%m-%d %H:%M:%S")
    w08.created_at = datetime.strptime("2023-05-18 00:09:16", "%Y-%m-%d %H:%M:%S")
    db.session.commit()
    print("TIME WARP! Adjusted workout created_at dates")
